...
// From https://monocleglobe.wordpress.com/2010/01/12/everybody-needs-a-little-printf-in-their-javascript/
// Changed name to format for my purposes.
...
// Modified to be an array prototype function.
...
window.Untrash = function(str)
{
	...
	{
		var tok = tokens[i];
		if (tok != "to" && tok != "the" && tok != "a" && tok != "some")
		{
			cleanse += tok + " ";
		}
	}
